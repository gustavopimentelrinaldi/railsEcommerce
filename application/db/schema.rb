...
ActiveRecord::Schema.define(version: 20171023172558) do
  ...
  create_table "adms", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_adms_on_category_id"
    t.index ["member_id"], name: "index_adms_on_member_id"
  end
  ...
  add_foreign_key "adms", "categories"
  add_foreign_key "adms", "members"
